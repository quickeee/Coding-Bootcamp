<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="org.afdemp.bootcamp.sofos.dao.StudentDAO, java.util.*"%>
...
<body>
		...
		<div class="container">
			...
			<div id="navbar" class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					...
					<li style="right: -300%"><a href="logout.jsp">Logout</a></li>
				</ul>
			</div>
			<!--/.nav-collapse -->
		</div>
	...
	<div class="container theme-showcase" role="main">
		...
		<div class="jumbotron">
			<h1>
				Hello,<%=user.getUsername().toString()%></h1>
		</div>
	...
	<div>
		<table class="table">
			...
			<%
				...
				students = (ArrayList<Student>) student.getStudents();

				if (students.size() == 0) {
			%>
			<tr>
				<td colspan=3><p class="bg-danger">Δεν υπάρχουν
						καταχωρημένοι φοιτητές</p></td>
			</tr>
			<%
				} else {
